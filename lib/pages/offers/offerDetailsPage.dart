...
class offerDetails extends StatefulWidget {
  final offerAllList offerItem;

  offerDetails(this.offerItem);
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Text(
                                  widget.offerItem.Durg +
                                      ' ( ' +
                                      ' ' +
                                      widget.offerItem.DurgForm +
                                      ' )',
                                  style: TextStyle(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        child: Text(
                                          widget.offerItem.TotalPrice.split('.')[0],
                                        ),
                                        padding:
                                        EdgeInsets.fromLTRB(5, 0, 5, 0),
                                      )
  ...
  Widget showDialogwindowDone(int wareId, int offerId) {
    return new AlertDialog(
      ...
      content: SingleChildScrollView(
        ...
        Padding(
          padding: EdgeInsets.fromLTRB(10, 20, 10, 20),child: Visibility(
          child: Form(
            key: fromdate,
            child: DateTimeField(
               ...
               ,
                Padding(
                  ...
                  child: new RaisedButton(
                      onPressed: () {
                        _buildSubmitFormCo(context, wareId, offerId, '1/1/1010');
                      }
                      ...
                      child: new RaisedButton(
                          onPressed: () {
                            ...
                            gg.add(Music(
                                ...
                                drugid: 0,
                                drugname: widget.offerItem.Durg,
                                drugprice: widget.offerItem.TotalPrice,wareN: widget.offerItem.Warehouse,
                                offeId: offerId,
                                quantity: 0,
                                wareId: wareId,
                                gift: gift,
  ...
  _save(List<Music> myListOfStringss,List<subList> lastLi, String wareName, String wareId) async {
    ...
    if (orderL != null) {
      ...
      if (orderLi[0].wareId.toString() ==
          widget.offerItem.WarehouseId.toString()) {
