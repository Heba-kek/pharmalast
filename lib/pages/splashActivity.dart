...
import 'package:pharmas/pages/pushpage.dart';
import 'dart:async';
            ...
            new Column(
              ...
              children: <Widget>[
                ...
                new Image.asset(
                  ...
                  width: isversion=='1'?animation.value * 100:animation.value * 150,
                  height: isversion=='1'?animation.value * 100:animation.value * 150,
                ):
                new Image.asset(
                  'assets/images/logo.png',
                  width:100,
