                                                    ...
                                                    child: Row(
                                                      children: <Widget>[
                                                        ...
                                                        Padding(
                                                            ...
                                                            child: Text(   'items[index].Phone',style: TextStyle(color: Colors.greyapp))
                                                        )
                                                      ],
                                                    ),
                                                  ),),visible: false,):
                                                    ...
                                                    child: GestureDetector(onTap: (){
                                                      ...
                                                      child: Row(
                                                        children: <Widget>[
                                                          ...
                                                          Padding(
                                                              padding: EdgeInsets.fromLTRB(15, 0, 15, 0),
                                                              child: Text(' items[index].Mobile',style: TextStyle(color: Colors.greyapp))
                                                          )
                                                        ],
                                                      ),
                                                    ),),visible: false,):
                                                  ...
                                                  Visibility(child: GestureDetector(onTap: (){
                                                    ...
                                                    child: Row(
                                                      children: <Widget>[
                                                        ...
                                                        Padding(
                                                            padding: EdgeInsets.fromLTRB(15, 0, 15, 0),
                                                            child: Text(   tListall[index].Phone,style: TextStyle(color: Colors.greyapp))
                                                        )
                                                      ],
                                                    ),
                                                  ),),visible: true,),
                                                    ...
                                                    child: GestureDetector(onTap: (){
                                                      ...
                                                      child: Row(
                                                        children: <Widget>[
                                                          ...
                                                          Padding(
                                                              padding: EdgeInsets.fromLTRB(15, 0, 15, 0),
                                                              child: Text(  tListall[index].Mobile,style: TextStyle(color: Colors.greyapp))
                                                          )
                                                        ],
                                                      ),
                                                    ),),visible: true,)
