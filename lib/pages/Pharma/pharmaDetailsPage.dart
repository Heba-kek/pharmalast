                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(color: Colors.greyapp),
                                    ),
                                  )
                                ],
                              ),
                            ...
                            widget.pharmaItem.Phone=="null"?Visibility(child:  GestureDetector(onTap: (){
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Padding(
                                      padding: EdgeInsets.fromLTRB(15, 0, 15, 0),
                                      child: Text(  widget.pharmaItem.Phone,style: TextStyle(color: Colors.greyapp))
                                  )
                                ],
                              ),
                            ),),visible: false,):
                            ...
                            widget.pharmaItem.Mobile=="null"?Visibility(child: GestureDetector(onTap: (){
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Padding(
                                      padding: EdgeInsets.fromLTRB(15, 0, 15, 0),
                                      child: Text(  widget.pharmaItem.Mobile,style: TextStyle(color: Colors.greyapp))
                                  )
                                ],
                              ),
                            ),),visible: false,):
